...
export default function PairedFlags() {
  ...
  return (
    <div className="container mx-auto p-6 max-w-4xl">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        <div>
          <h1 className="text-3xl font-bold text-neutral-800">Relationship Pattern Guide</h1>
          <p className="text-neutral-600 mt-2">Compare healthy and unhealthy behaviors by theme</p>
        </div>
        ...
        <div className="flex gap-3 flex-wrap">
          ...
          <Dialog open={isImportDialogOpen} onOpenChange={setIsImportDialogOpen}>
            ...
            <DialogContent className="max-w-2xl">
              <DialogHeader>
                <DialogTitle>Import Paired Flag Data</DialogTitle>
              </DialogHeader>
      ...
      {filteredFlags.length > 0 && (
        <div className="text-center mt-12 pt-8 border-t border-neutral-200">
          <p className="text-sm text-neutral-500">
            Explore healthy relationship patterns and recognize warning signs
          </p>
        </div>
      )}
    </div>
